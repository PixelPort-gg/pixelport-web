...
[Party Jousting](/mac/party-jousting-437900/) is a free one-button party game for 2 to 16 players sharing a keyboard or controllers. It is ten years old, it is brilliant in the way only one-button games can be, and it now runs on Apple Silicon.
...
Want to play? See [how to play DSS 2: War Industry on Mac](/mac/dss-2-war-industry-3582440/) and [how to play Party Jousting on Mac](/mac/party-jousting-437900/), or [download Pixel Port](/download) and try the DSS 2 demo in one click.
